...
class AppendedPathTemplate<T, U>(private val tScheme: PathTemplate<T>, private val uScheme: PathTemplate<U>) :
  PathTemplate<Tuple2<T, U>> {
...
class PrefixedPathTemplate<T>(private val prefix: PathTemplate<Unit>, private val rest: PathTemplate<T>) :
  PathTemplate<T> {
...
class SuffixedPathTemplate<T>(private val first: PathTemplate<T>, private val suffix: PathTemplate<Unit>) :
  PathTemplate<T> {
  override fun pathElementsFrom(value: T) =
